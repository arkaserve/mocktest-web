...
const EXAMS = [
  ...
  { group:'RRB', id:'rrb_clerk_pre', name:'RRB Office Assistant', level:'Prelims', total:80, duration:'45 min', negative:0.25,
    sections:[
      { label:'Numerical Ability', q:40, mins:'—', topics:T.numerical },
      { label:'Reasoning Ability', q:40, mins:'—', topics:T.reasoning },
    ]},
  { group:'RRB', id:'rrb_clerk_mains', name:'RRB Office Assistant', level:'Mains', total:200, duration:'120 min', negative:0.25,
    sections:[
      { label:'Reasoning Ability', q:40, mins:'—', topics:T.reasoning },
      { label:'Numerical Ability', q:40, mins:'—', topics:T.numerical },
  ...
  { group:'RRB', id:'rrb_po_pre', name:'RRB Officer Scale I', level:'Prelims', total:80, duration:'45 min', negative:0.25,
    sections:[
      { label:'Reasoning Ability', q:40, mins:'—', topics:T.reasoning },
      { label:'Quantitative Aptitude', q:40, mins:'—', topics:T.numerical },
    ]},
  { group:'RRB', id:'rrb_po_mains', name:'RRB Officer Scale I', level:'Mains', total:200, duration:'120 min', negative:0.25,
    sections:[
      { label:'Reasoning Ability', q:40, mins:'—', topics:T.reasoning },
      { label:'Quantitative Aptitude', q:40, mins:'—', topics:T.numerical },
      { label:'General Awareness', q:40, mins:'—', topics:T.ga },
