...
const EXAM_TREE = [
  { bank:'IBPS', exams:[
    { id:'bank_clerk_prelims', name:'IBPS Clerk', badge:'Clerk', level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','numerical_ability','reasoning'], pattern:{english:30,numerical_ability:35,reasoning:35} },
    { id:'bank_clerk_mains',   name:'IBPS Clerk',   badge:'Clerk', level:'Mains',   questions:175, duration:'160 min', negative:0.25, sections:['general_financial_awareness','general_english','reasoning_computer_aptitude','quantitative_aptitude'], pattern:{general_financial_awareness:50,general_english:45,reasoning_computer_aptitude:40,quantitative_aptitude:40} },
    { id:'bank_po_prelims',    name:'IBPS PO',    badge:'PO',    level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning'], pattern:{english:30,quantitative_aptitude:35,reasoning:35} },
    { id:'bank_po_mains',      name:'IBPS PO',      badge:'PO',    level:'Mains',   questions:175, duration:'180 min', negative:0.25, sections:['reasoning_computer_aptitude','english_language','data_analysis_interpretation','general_economy_banking'], pattern:{reasoning_computer_aptitude:45,english_language:45,data_analysis_interpretation:45,general_economy_banking:40} },
  ]},
    { bank:'IBPS RRB', exams:[
    { id:'rrb_office_assistant_prelims', name:'Office Assistant', badge:'OA',    level:'Prelims', questions:80,  duration:'45 min',  negative:0.25, sections:['reasoning','numerical_ability'],                                                                       pattern:{reasoning:40,numerical_ability:40} },
    { id:'rrb_office_assistant_mains',   name:'Office Assistant',   badge:'OA',    level:'Mains',   questions:200, duration:'120 min', negative:0.25, sections:['reasoning','numerical_ability','general_awareness','english_hindi','computer_knowledge'],               pattern:{reasoning:40,numerical_ability:40,general_awareness:40,english_hindi:40,computer_knowledge:40} },
    { id:'rrb_officer_scale1_prelims',   name:'Officer Scale-I',  badge:'PO',    level:'Prelims', questions:80,  duration:'45 min',  negative:0.25, sections:['reasoning','quantitative_aptitude'],                                                                    pattern:{reasoning:40,quantitative_aptitude:40} },
    { id:'rrb_officer_scale1_mains',     name:'Officer Scale-I',    badge:'PO',    level:'Mains',   questions:200, duration:'120 min', negative:0.25, sections:['reasoning','quantitative_aptitude','general_awareness','english_hindi','computer_knowledge'],            pattern:{reasoning:40,quantitative_aptitude:40,general_awareness:40,english_hindi:40,computer_knowledge:40} },
  ]},
  { bank:'SBI', exams:[
    { id:'sbi_clerk_prelims', name:'SBI Clerk', badge:'Clerk', level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','numerical_ability','reasoning'], pattern:{english:30,numerical_ability:35,reasoning:35} },
    { id:'sbi_clerk_mains',   name:'SBI Clerk',   badge:'Clerk', level:'Mains',   questions:170, duration:'160 min', negative:0.25, sections:['general_english','quantitative_aptitude','reasoning_computer_aptitude','general_financial_awareness'], pattern:{general_english:45,quantitative_aptitude:40,reasoning_computer_aptitude:40,general_financial_awareness:45} },
    { id:'sbi_po_prelims',    name:'SBI PO',    badge:'PO',    level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning'], pattern:{english:30,quantitative_aptitude:35,reasoning:35} },
    { id:'sbi_po_mains',      name:'SBI PO',      badge:'PO',    level:'Mains',   questions:175, duration:'180 min', negative:0.25, sections:['reasoning_computer_aptitude','data_analysis_interpretation','general_economy_banking','english_language'], pattern:{reasoning_computer_aptitude:45,data_analysis_interpretation:45,general_economy_banking:40,english_language:45} },
  ]},
  { bank:'RBI', exams:[
    { id:'rbi_assistant_pre',   name:'RBI Assistant', badge:'Assistant', level:'Prelims', questions:100, duration:'60 min',  negative:0.25, sections:['english','numerical_ability','reasoning'], pattern:{english:30,numerical_ability:35,reasoning:35} },
    { id:'rbi_assistant_mains', name:'RBI Assistant',   badge:'Assistant', level:'Mains',   questions:190, duration:'135 min', negative:0.25, sections:['general_financial_awareness','general_english','reasoning_computer_aptitude','quantitative_aptitude'], pattern:{general_financial_awareness:50,general_english:45,reasoning_computer_aptitude:40,quantitative_aptitude:40} },
    { id:'rbi_gradeb_p1',       name:'RBI Grade B', badge:'Grade B',   level:'Phase 1', questions:155, duration:'120 min', negative:0.25, sections:['reasoning_computer_aptitude','english_language','data_analysis_interpretation','general_economy_banking'], pattern:{reasoning_computer_aptitude:45,english_language:45,data_analysis_interpretation:45,general_economy_banking:40} },
  ]},
  { bank:'NABARD', exams:[
    { id:'nabard_gradeA_pre', name:'NABARD Grade A',         badge:'Grade A', level:'Prelims', questions:190, duration:'120 min', negative:0.25, sections:['general_financial_awareness','general_english','reasoning_computer_aptitude','quantitative_aptitude'], pattern:{general_financial_awareness:50,general_english:45,reasoning_computer_aptitude:40,quantitative_aptitude:40} },
  ...
  { bank:'LIC', exams:[
    { id:'lic_aao_pre',       name:'LIC AAO',       badge:'AAO',       level:'Prelims', questions:100, duration:'60 min',  negative:0.25, sections:['english','quantitative_aptitude','reasoning','insurance_awareness'],          pattern:{english:30,quantitative_aptitude:35,reasoning:25,insurance_awareness:10} },
    { id:'lic_aao_mains',     name:'LIC AAO',         badge:'AAO',       level:'Mains',   questions:120, duration:'120 min', negative:0.25, sections:['general_knowledge_current_affairs','reasoning','data_analysis_interpretation','insurance_financial_awareness'], pattern:{general_knowledge_current_affairs:30,reasoning:30,data_analysis_interpretation:30,insurance_financial_awareness:30} },
    { id:'lic_assistant_pre', name:'LIC Assistant', badge:'Assistant', level:'Prelims', questions:100, duration:'60 min',  negative:0.25, sections:['english','numerical_ability','reasoning'],                                   pattern:{english:30,numerical_ability:35,reasoning:35} },
    { id:'lic_ado_pre',       name:'LIC ADO',       badge:'ADO',       level:'Prelims', questions:100, duration:'60 min',  negative:0.25, sections:['english','numerical_ability','reasoning'],                                        pattern:{english:30,numerical_ability:35,reasoning:35} },
    { id:'lic_ado_mains',     name:'LIC ADO',         badge:'ADO',       level:'Mains',   questions:120, duration:'120 min', negative:0.25, sections:['reasoning_ability','numerical_ability','insurance_financial_awareness'],               pattern:{reasoning_ability:40,numerical_ability:40,insurance_financial_awareness:40} },
  ]},
  { bank:'Insurance', exams:[
    { id:'nicl_ao_pre',         name:'NICL AO',         badge:'NICL',   level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning','insurance_awareness'], pattern:{english:30,quantitative_aptitude:35,reasoning:25,insurance_awareness:10} },
    { id:'uiic_ao_pre',         name:'UIIC AO',         badge:'UIIC',   level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning','insurance_awareness'], pattern:{english:30,quantitative_aptitude:35,reasoning:25,insurance_awareness:10} },
    { id:'niacl_ao_pre',        name:'NIACL AO',        badge:'NIACL',  level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning','insurance_awareness'], pattern:{english:30,quantitative_aptitude:35,reasoning:25,insurance_awareness:10} },
    { id:'oicl_ao_pre',         name:'OICL AO',         badge:'OICL',   level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','quantitative_aptitude','reasoning','insurance_awareness'], pattern:{english:30,quantitative_aptitude:35,reasoning:25,insurance_awareness:10} },
    { id:'niacl_assistant_pre', name:'NIACL Assistant', badge:'NIACL',  level:'Prelims', questions:100, duration:'60 min', negative:0.25, sections:['english','numerical_ability','reasoning'], pattern:{english:30,numerical_ability:35,reasoning:35} },
  ]},
  ...
  { bank:'SSC', exams:[
    { id:'ssc_cgl_tier1',  name:'SSC CGL',  badge:'CGL',  level:'Tier I', questions:100, duration:'60 min', negative:0.50, sections:['general_intelligence_reasoning','general_awareness','quantitative_aptitude','english_comprehension'], pattern:{general_intelligence_reasoning:25,general_awareness:25,quantitative_aptitude:25,english_comprehension:25} },
    { id:'ssc_chsl_tier1', name:'SSC CHSL', badge:'CHSL', level:'Tier I', questions:100, duration:'60 min', negative:0.50, sections:['general_intelligence','general_awareness','quantitative_aptitude','english_language'], pattern:{general_intelligence:25,general_awareness:25,quantitative_aptitude:25,english_language:25} },
    { id:'ssc_mts_paper1', name:'SSC MTS', badge:'MTS',  level:'Paper I', questions:80, duration:'90 min', negative:0,    sections:['numerical_mathematical_ability','reasoning_problem_solving','general_english','general_awareness'], pattern:{numerical_mathematical_ability:20,reasoning_problem_solving:20,general_english:20,general_awareness:20} },
  ]},
  { bank:'RRB', exams:[
    { id:'rrb_ntpc_cbt1', name:'RRB NTPC', badge:'NTPC', level:'CBT 1', questions:100, duration:'90 min', negative:0.33, sections:['mathematics','general_intelligence_reasoning','general_awareness'], pattern:{mathematics:30,general_intelligence_reasoning:30,general_awareness:40} },
    { id:'rrb_ntpc_cbt2', name:'RRB NTPC', badge:'NTPC', level:'CBT 2', questions:120, duration:'90 min', negative:0.33, sections:['mathematics','general_intelligence_reasoning','general_awareness'], pattern:{mathematics:35,general_intelligence_reasoning:35,general_awareness:50} },
    ...
    { id:'rrb_alp_cbt1',  name:'RRB ALP',  badge:'ALP',  level:'CBT 1', questions:75, duration:'60 min', negative:0.33, sections:['mathematics','general_intelligence_reasoning','general_science'], pattern:{mathematics:20,general_intelligence_reasoning:25,general_science:30} },
  ]},
]
