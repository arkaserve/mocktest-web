export default function TermsPage() {
  ...
  const sections=[
    {title:'1. Acceptance of terms',body:`By accessing or using MockTest (mocktest.anilsofttech.com), a service of Anil Software Technologies, you agree to be bound by these Terms of Service and our Privacy Policy.`},
          ...
          {sections.map(sec=>(
            <div key={sec.title} style={{marginBottom:36}}>
              ...
              {sec.contact&&<div style={{background:'#F8F8F8',border:'1px solid #EBEBEB',borderRadius:11,padding:18,fontSize:13,color:'#555',display:'flex',flexDirection:'column',gap:6}}>
                <div><strong>Anil Software Technologies</strong></div>
